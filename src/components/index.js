...
function handleEditProfileSubmit(evt) {
  ...
  const formSubmitButton = evt.submitter;
...
editProfileButton.addEventListener('click', () => {
  ...
  clearValidation(editProfileForm, validationConfig); // Добавлено очищение ошибок
  openModal(editProfileModal);
});

addCardButton.addEventListener('click', () => {
  addCardForm.reset(); // Сбрасываем значения формы
